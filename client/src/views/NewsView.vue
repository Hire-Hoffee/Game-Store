...
<template>
  <div v-if="!getLoadingStatus">
    ...
    <div
      ...
      <RouterLink class="md:w-1/2 h-1/2 md:h-full" :to="{ name: 'newsContent', params: { newsId: item.id } }" v-for="item in latestNews">
    ...
    <div>
      <NewsComponent v-for="item in allNews" 
        :newsTitle="item.title" 
        :newsPoster="item.poster"
