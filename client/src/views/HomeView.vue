  ...
  <div class="main_page" v-if="!getLoadingStatus">
    ...
    <div class="mb-28 bg-slate-400 dark:bg-custom-gray bg-opacity-50 p-3 rounded">
      <div class="flex justify-between mb-3">
        ...
        <h1 class="text-xl text-custom-red"><RouterLink :to="{ name: 'gamesNews' }">View all</RouterLink></h1>
      </div>
      <hr class="w-full h-0.5 bg-custom-red border-none">
    ...
    <div>
      <div class="flex justify-between mb-5">
        ...
        <h1 class="text-xl text-custom-red"><RouterLink :to="{ name: 'allCategories' }">View all</RouterLink></h1>
      </div>
      <hr class="w-full h-0.5 bg-custom-red border-none">
      <div class="flex justify-between flex-wrap mt-5">
        <CategoryCard v-if="popCategories" v-for="category in popCategories" 
