...
<template>
  <footer class="bg-custom-black w-full h-16 flex justify-between items-center px-12 font-bold drop_shadow_custom_up">
    <div class="text-xl text-custom-red ">
      <h1>GameMuffin</h1>
    </div>
