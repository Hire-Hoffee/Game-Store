...
<header v-if="!isMobile" class="bg-custom-black w-full h-16 flex justify-between items-center px-12 font-bold z-50 drop_shadow_custom_down">
  <div class="flex items-center space-x-7 text-2xl text-custom-red">
    ...
    <h1 class="sm:hidden xl:block hidden"><router-link to="/">GameMuffin</router-link></h1>
  </div>
  <nav>
    <ul class="flex space-x-6 md:space-x-8 xl:space-x-12 text-xl">
      <li><RouterLink to="/games/all">All games</RouterLink></li>
   ...
   <div class="sm:block lg:hidden" @click="clickToSearch">
    ...
    <div class="sm:hidden lg:block hidden">
      <form class="flex space-x-7">
        <input type="text" class="px-1 text-lg text-custom-black rounded focus:outline-none focus:ring-custom-red focus:ring-2" placeholder="Search game">
  ...
  <div v-if="search" class="absolute right-0 top-16 px-5 mt-5 w-full">
    <form class="flex space-x-7">
      <input type="text" class="px-1 text-lg text-custom-black rounded focus:outline-none focus:ring-custom-red focus:ring-2 w-10/12" placeholder="Search game">
